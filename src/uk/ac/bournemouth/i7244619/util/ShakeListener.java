package uk.ac.bournemouth.i7244619.util;
...
public class ShakeListener implements SensorListener {
	...
	public void resume() {
		...
		boolean supported =
				mSensorMgr.registerListener(this, SensorManager.SENSOR_ACCELEROMETER,
	...
	public void onSensorChanged(int sensor, float[] values) {
		...
		if ((now - mLastTime) > TIME_THRESHOLD) {
			...
			float speed =
					Math.abs(values[SensorManager.DATA_X] + values[SensorManager.DATA_Y]
